...
/* private function---------------------------------------------------------- */
#define  LCD_CS_SET    GPIO_SetBits(LCD_CS_PORT, GPIO_Pin_6)
#define  LCD_CS_CLR    GPIO_ResetBits(LCD_CS_PORT, GPIO_Pin_6)

#define  LCD_RS_SET    GPIO_SetBits(LCD_RS_PORT, GPIO_Pin_13)
#define  LCD_RS_CLR    GPIO_ResetBits(LCD_RS_PORT, GPIO_Pin_13)

#define  LCD_WR_SET    GPIO_SetBits(LCD_WR_PORT, GPIO_Pin_14)
#define  LCD_WR_CLR    GPIO_ResetBits(LCD_WR_PORT, GPIO_Pin_14)

#define  LCD_RD_SET    GPIO_SetBits(LCD_RD_PORT, GPIO_Pin_15)
#define  LCD_RD_CLR      GPIO_ResetBits(LCD_RD_PORT, GPIO_Pin_15)
